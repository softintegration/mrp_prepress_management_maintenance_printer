...
class MrpWorkorder(models.Model):
    ...
    def _get_duration_expected(self, alternative_workcenter=False, ratio=1):
        ...
        if alternative_workcenter:
            ...
            return (alternative_workcenter.time_start + alternative_workcenter.time_stop + alternative_wc_cycle_nb * duration_expected_working * 100.0 / alternative_workcenter.time_efficiency)*passes_nbr
